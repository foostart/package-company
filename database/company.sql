...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `company_slug` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `company_overview` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `company_description` longtext COLLATE utf8_unicode_ci,
  `company_image` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `company_files` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `company_status` tinyint(4) DEFAULT NULL,
  `cache_comments` text COLLATE utf8_unicode_ci,
  `cache_other_company` text COLLATE utf8_unicode_ci,
